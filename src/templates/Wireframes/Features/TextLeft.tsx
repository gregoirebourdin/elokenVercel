...
export default function TextLeft({tag, title, description, image, link, linkText}) {
    return (
        <>
            <div className="">
                <div className="grid md:grid-cols-2 items-center justify-center gap-6 lg:gap-24">
